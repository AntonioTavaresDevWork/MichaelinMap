...
| BL-22 | Sem Vitest configurado | **A previsão se cumpriu na S06:** a semântica OR/AND do filtro é a primeira lógica do projeto que justifica teste. Foi verificada por um harness descartável (27 checks contra o banco vivo pelo caminho anon), não por suíte versionada — então a próxima mudança no filtro não tem rede. Configurar Vitest e portar os checks é o caminho; o harness da S06 serve de ponto de partida |
